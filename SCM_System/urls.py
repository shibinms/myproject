...
urlpatterns = [
    ...
    path('adm_allocate_raw_material/<int:id>', views.adm_allocate_raw_material),
    path('adm_allocate_raw_material_post/', views.adm_allocate_raw_material_post),
    ...
    path('adm_view_material_allocated/<int:id>', views.adm_view_material_allocated),
    path('adm_view_material_requested/<int:id>', views.adm_view_material_requested),
    ...
    path('adm_production_details/<int:id>', views.adm_production_details),
    ...
    path('adm_view_sales_details_admin/<int:id>', views.adm_view_sales_details_admin),
    ...
    path('sales_view_product_new_sales_staff/',views.sales_view_product_new_sales_staff),
    path('sales_view_product_new_details_sales_staff/<int:id>',views.sales_view_product_new_details_sales_staff),
    path('sales_delivered/<int:id>',views.sales_delivered),
    path('sales_view_product_delivered_details_sales_staff/<int:id>',views.sales_view_product_delivered_details_sales_staff),
    path('sales_view_product_delivered_sales_staff/',views.sales_view_product_delivered_sales_staff),
    path('sales_view_profile/',views.sales_view_profile),
    path('sales_edit_profile/<int:id>',views.sales_edit_profile),
    path('sales_edit_profile_update/',views.sales_edit_profile_update),
    path('sales_view_sales_details/<int:id>',views.sales_view_sales_details),
    path('sales_phone_number_search/',views.sales_phone_number_search),
    path('sales_phone_number_search/',views.sales_phone_number_search),
    path('sales_date_search_sales_report/',views.sales_date_search_sales_report),
    path('adm_notification_branch_name_search/',views.adm_notification_branch_name_search),
    path('adm_date_search_view_request/',views.adm_date_search_view_request),
    path('adm_branch_name_search_view_requst/',views.adm_branch_name_search_view_requst),
    ...
    path('production_usage_details/<int:id>',views.production_usage_details),
    ...
    path('production_update_production_details/<int:id>',views.production_update_production_details),
    path('production_out_for_delivery/<int:id>',views.production_out_for_delivery),
    path('production_view_production_report/',views.production_view_production_report),
    path('production_production_details/<int:id>',views.production_production_details),
    path('production_date_search/',views.production_date_search),
    path('production_request_material_production/',views.production_request_material_production),
    path('production_request_material_post/',views.production_request_material_post),
    path('production_product_name_search/',views.production_product_name_search),
    path('production_del_cart/<int:id>',views.production_del_cart),
    ...
    path('manager_view_products_delivered_details/<int:id>', views.manager_view_products_delivered_details),
    path('manager_staff_name_search/', views.manager_staff_name_search),
    path('manager_phone_number_search/', views.manager_phone_number_search),
    path('manager_product_name_search/', views.manager_product_name_search),
    path('manager_view_request/', views.manager_view_request),
    path('manager_view_request_details/<int:id>', views.manager_view_request_details),
    path('manager_del_rqst/<int:id>', views.manager_del_rqst),
    path('manager_edit_profile/<int:id>', views.manager_edit_profile),
    path('manager_edit_profile_post/', views.manager_edit_profile_post),
    path('manager_forwarded/<int:id>', views.manager_forwarded),
    path('manager_view_materials_allocated/', views.manager_view_materials_allocated),
    path('manager_allocate_details/<int:id>', views.manager_allocate_details),
    path('manager_view_stock/', views.manager_view_stock),
    path('manager_view_notification/', views.manager_view_notification),
    path('manager_date_search_view_request/', views.manager_date_search_view_request)
